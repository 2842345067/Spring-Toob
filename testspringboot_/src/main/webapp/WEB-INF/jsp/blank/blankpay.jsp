  ...
  <div id="page-wrapper">
            <div class="container-fluid">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                       <a onclick="login_but()" target="_blank" class="btn btn-danger pull-right m-l-20 hidden-xs hidden-sm waves-effect waves-light">退出登录</a>
                        <ol class="breadcrumb">
                            ...
                            <li class="active"><a href="../blan/blankpay?uid=${tbuser1[0].uid}">支出详情</a></li>
                        </ol>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title">支出详情
                            <label style="margin-left: 40%;"class="text-danger">支出金额:$${zhichu==0?'':'-'}${zhichu}</label>
                            </h3>
                            <div class="table-responsive">
                                <table class="table">
                                 ...
                                 <tbody>
											...
											<c:forEach  items="${selectLePayer}"  var="tak">
	...
	function login_but(){
				...
				if (r==true){
					...
					location.href='${pageContext.request.contextPath}/blan/blankpay?uid=${sessionScope.user.uid}';
				}
