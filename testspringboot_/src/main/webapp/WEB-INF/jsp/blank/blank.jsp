  ...
  <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title">记录详情
                            <label style="margin-left: 40%;" class="${zong>0?'text-success':'text-danger'}">当前金额:$${zong}</label>
							<a href="../blan/blankpay?uid=${tbuser1[0].uid}"  class="btn btn-danger" style="float:right;margin-left: 5px;">支出</a>
                            <a href="../blan/blankexpenditure?uid=${tbuser1[0].uid}"  class="btn btn-success" style="float:right;margin-left: 5px;">支入</a> 
                            </h3>
	...
	function login_but(){
				...
				if (r==true){
					...
					location.href='${pageContext.request.contextPath}/blan/blank?uid=${sessionScope.user.uid}';
				}
