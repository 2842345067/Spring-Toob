   ...
   <nav class="navbar navbar-default navbar-static-top m-b-0">
                ...
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active"><a href="../shee/sheetinsert?uid=${tbuser1[0].uid}">新建</a></li>
                        </ol>
                    </div>
                </div>
                <!-- /.row -->
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                 	<div class="col-md-12">
                                	<input type="radio" checked="checked" name="radioid" id="" value="支入" onclick="but(this)">支入
									<input type="radio" name="radioid" id="" value="支出"  onclick="but(this)">支出
									</div>
                                </div>
                                 <div class="form-group">
								...
								<c:forEach  items="${classifyTbl}"  var="tbl">
									<option value="${tbl.cid}" >${tbl.classify}</option>
									</c:forEach>
								...
								<c:forEach  items="${classifyruTbl}"  var="tbl">
									<option value="${tbl.rid}" >${tbl.classifyru}</option>
									</c:forEach>
                            ...
                            <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <textarea rows="5" class="form-control form-control-line" id="detail"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text"  id="money" 	value="" class="form-control form-control-line">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-12">
                                    <a onclick='sheetinsert_but()'  class="btn btn-success">
                                     		 确定
                                        </a>
		 ...
		 if($('input[name="radioid"]:checked').val()=="支入"){
			 $.ajax({
			 	 	type:"post", //请求方式 get，post
		 	 	 	url:"${pageContext.request.contextPath}/shee/insert",
		 	 	 	data:{
		 	 	 		"detail":$('#detail').val(),
	...
	function login_but(){
				...
				if (r==true){
					...
					location.href='${pageContext.request.contextPath}/shee/sheetinsert?uid=${sessionScope.user.uid}';
				}
    ...
    <script>
        ...
        document.getElementById("time").innerHTML = "创建时间："+y+"-"+M+"-"+d+" "+H+":"+m+":"+s;
    </script>
